...
-(id)init
{
    if(self = [super init]) {
        ...
        [windowController setWindowFrameAutosaveName:@"LayupsReactNative"];
...
- (void)setUpApplicationMenu
{
    ...
    [rootMenu addItemWithTitle:@"Quit LayupsReactNative" action:@selector(terminate:) keyEquivalent:@"q"];
